...
<Cards>
  ...
  <Card title="Advanced Features" href="/docs/guide/advanced" description="Rate limiting and delays" />
  <Card title="Event Streaming" href="/docs/guide/event-streaming" description="Monitor executions in real time" />
</Cards>
