...
<Cards>
  <Card title="Rate Limiting" href="/docs/guide/advanced#rate-limiting" description="Control request rates to external services" />
  <Card title="Retry Policies" href="/docs/guide/advanced#retries" description="Configure retry behavior with backoff strategies" />
  <Card title="Error Handling" href="/docs/guide/error-handling" description="DLQ and error management" />
</Cards>
