...
<Cards>
  <Card title="Circuit Breakers" href="/docs/guide/circuit-breakers" description="Protect external services with circuit breaking" />
  <Card title="Event Streaming" href="/docs/guide/event-streaming" description="Real-time workflow event subscriptions" />
  <Card title="API Reference" href="/docs/reference/api/state-store" description="Complete state store API reference" />
</Cards>
