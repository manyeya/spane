...
<Cards>
  <Card title="Installation" href="/docs/getting-started/installation" description="Get started with SPANE" />
  <Card title="Examples" href="/docs/reference/examples" description="Practical examples and recipes" />
