...
<Cards>
  <Card title="Installation & Setup" href="/docs/installation" description="Complete installation guide and environment setup" />
  ...
  <Card title="API Reference" href="/docs/api" description="Complete API reference for all components" />
  <Card title="Examples" href="/docs/examples" description="Practical examples and common patterns" />
</Cards>
