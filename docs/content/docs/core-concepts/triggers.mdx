...
<Cards>
  ...
  <Card title="API Reference" href="/docs/api/workflow-engine" description="Complete WorkflowEngine API reference" />
  <Card title="Examples" href="/docs/examples" description="Practical trigger examples" />
</Cards>
